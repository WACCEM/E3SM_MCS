...
def plot_map_2panels(pixel_dict, plot_info, map_info, track_dict):
    ...
    mcsperim_alpha = plot_info['mcsperim_alpha']
    ...
    Tn[Tn > 0] = 10
    tn1 = ax1.pcolormesh(lon, lat, Tn, cmap='cool_r', transform=data_proj, zorder=3, alpha=mcsperim_alpha)
    # Tb Colorbar
...
if __name__ == "__main__":
    ...
    pcp_levels = [1, 1.5, 2, 3, 4, 5, 6, 8, 10, 15]
