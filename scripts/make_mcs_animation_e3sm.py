...
config_file = f"/global/homes/f/feng045/program/e3sm_polun/tracking/slurm_mcs_E3SM_ctl_2001.sh"

parallel_mode = 1
n_workers = 128
figsize_x = 15  # Width in inches (height is auto-calculated to maintain aspect ratio)
...
if data_type == "tbpf":
    ...
    figdir = f"/pscratch/sd/f/feng045/E3SM_polun/E3SM_CTL/quicklooks_{plot_type}_{data_type}/{start_year}/"
    animation_dir = f"/pscratch/sd/f/feng045/E3SM_polun/E3SM_CTL/animations_{plot_type}_{data_type}/"
elif data_type == "tbze":
