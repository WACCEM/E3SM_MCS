...
for the E3SM ne30 ctl.fr tracking run.

Outputs written to the same directory as this script:
  tasklist_mcs_monthly_rainmap_E3SM_ctl.txt
  slurm.submit_mcs_monthly_rainmap_E3SM_ctl.sh
...
1° (ne30) data is smaller, so this is a generous upper bound.
...
Usage examples:
  # Default range (2001-01 to 2020-12)
  python gen_e3sm_mcs_monthly_stats_taskfarmer.py

  # Custom range
  python gen_e3sm_mcs_monthly_stats_taskfarmer.py --start-date 2005-01 --end-date 2010-12

  # Adjust nodes and threads
  python gen_e3sm_mcs_monthly_stats_taskfarmer.py --nodes 2 --threads 8 --qos debug --time 00:30:00

Run in the pyflex26.3 environment:
  /global/common/software/m1867/python/pyflex26.3/bin/python gen_e3sm_mcs_monthly_stats_taskfarmer.py
"""
...
# Output filenames
TASKLIST_FNAME = "tasklist_mcs_monthly_rainmap_E3SM_ctl.txt"
SLURM_FNAME    = "slurm.submit_mcs_monthly_rainmap_E3SM_ctl.sh"

# Per-year config filename pattern
CONFIG_BASENAME = "config_mcs_tbpf_E3SM_ctl_{year}.yml"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            ...
            "rain-map statistics (E3SM ne30 ctl.fr)."
        ),
...
#SBATCH --exclusive
#SBATCH --output=logs/log_mcs_monthly_rainmap_E3SM_ctl.log
